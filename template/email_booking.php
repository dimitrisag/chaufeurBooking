...
?>
								...
								<tr>
									<td>
										Please Note: For any help / clarification you will need about your transfer don't hesitate to contact us at (+30)6934034713
...
?>
								...
								<!-- -->
<?php
		if(((int)$this->data['booking']['meta']['service_type_id']===3) || (((int)$this->data['booking']['meta']['service_type_id']===1) && ((int)$this->data['booking']['meta']['extra_time_enable']===1)))
		{
?>											
...
<ul>
  <li>TRANSFERS FROM ATHENS AIRPORT: The driver will meet you in the arrival hall holding a sign displaying your name. The driver will wait for a maximum of 1 hour after your flight arrival. Athens airport provides free WIFI access. <strong>Please open your phone</strong>, so the driver can contact you easily. Athens Airport, provides free WiFi.</li>
  <li>TRANSFERS FROM PIRAEUS / RAFINA / LAVRIO PORTS: The driver will wait for you at the exact point of your arrival holding a sign displaying your name. The driver will wait for a maximum of 30 minutes after your ship arrival.</li>
  <li>TRANSFERS FROM HOTELS: The driver will meet you at the lobby of your hotel.</li>
  <li>CHANGES TO YOUR RESERVATION: Any modifications to your reservation must be emailed to us a minimum of 12 hours before your scheduled transfer and are subject to approval. Cancellations must be emailed to us a minimum of 24 hours before the day of your transfer. Please note that all communication, including modifications and cancellations, must be made directly through our office via email. We are not responsible for any arrangements made directly with your driver.</li>
</ul>

<div>Please Note: Orders are subject to our Terms & Conditions and our Privacy Policy.
We welcome all comments on the services we provide.
Have a pleasant journey!</div>
						</td>
					</tr>
<?php ?>
<?php	
