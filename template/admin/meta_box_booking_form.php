...
?>
										...
										<td>
											<div class="to-clear-fix">											
												<select name="<?php CHBSHelper::getFormName('form_element_field[pickup_location][]'); ?>" id="form_element_field_pickup_location" class="to-dropkick-disable chbs-pickup-location" multiple="multiple" size="3">
													<option value="-1" selected="selected"><?php esc_html_e('- None -','chauffeur-booking-system'); ?></option>
<?php
		foreach($this->data['dictionary']['location'] as $index=>$value)
			echo '<option value="'.esc_attr($index).'">'.esc_html($value['post']->post_title).'</option>';
...
?>
										...
										<td>
											<div class="to-clear-fix">											
												<select name="<?php CHBSHelper::getFormName('form_element_field[pickup_location][]'); ?>" id="<?php CHBSHelper::getFormName('form_element_field_pickup_location_'.$fieldValue['id']); ?>"  class="to-dropkick-disable chbs-pickup-location" multiple="multiple" size="3">
													<option value="-1" <?php echo ((is_array($fieldValue['pickup_location'])) && (in_array(-1,$fieldValue['pickup_location'])) ? ' selected="selected"' : ''); ?>><?php esc_html_e('- None -','chauffeur-booking-system'); ?></option>
<?php
				foreach($this->data['dictionary']['location'] as $index=>$value)
					echo '<option value="'.esc_attr($index).'" '.((is_array($fieldValue['pickup_location'])) && (in_array($index,$fieldValue['pickup_location'])) ? ' selected="selected"' : '').'>'.esc_html($value['post']->post_title).'</option>';
?>
												</select>
												<input type="hidden" value="" name="<?php CHBSHelper::getFormName('form_element_field[pickup_location_hidden][]'); ?>"/>
											</div>
