...
class CHBSBookingFormElement
{
	...
	function validateField($meta,$data)
	{
		...
		foreach($meta['form_element_field'] as $value)
		{
			...
			/*
			TODO: restrict from view
			echo $data;
			echo $value;
			
			
			if (isset($value['pickup_location']) && $data['pickup_location'] == $value['pickup_location']) continue;
			*/
			//if (array_key_exists($value['pickup_location'],$locationDictionary)) continue; location_fixed_pickup
